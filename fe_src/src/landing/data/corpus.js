/* ============================================================
   Landing — knowledge corpus (pure data, no logic)
   ------------------------------------------------------------
   Each entry is both a graph node (projects only) and a
   retrievable document. `blurb` is the retrieval surface: the
   bag of words a question is matched against. `desc` is what
   the answer layer actually quotes.
   ============================================================ */
...
export const PROJECTS = [
  ...
  },
  {
    ...
    year: '2025',
    lean: 'ml',
    tags: ['embeddings', 'on-device', 'retrieval'],
    stack: 'JavaScript · embeddings · canvas',
    desc:
      'This page. Your question is embedded on-device and my work is ranked by ' +
      'cosine similarity, then drawn as a force-directed map and answered with RAG.',
    url: '#',
    blurb:
      'semantic search embeddings on device retrieval vector similarity rag ' +
...
/* Retrievable but not a graph node. */
export const BIO = {
  id: 'bio',
  kind: 'bio',
  title: 'Jae Hong Lee',
  ...
  blurb:
    ...
    'science visual arts ai machine learning interface design build models on device ' +
    'front end research typography craft precision hire contact collaboration',
};

export const KNOWLEDGE = [...PROJECTS, BIO];
