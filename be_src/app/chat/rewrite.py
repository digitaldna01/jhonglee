...
_RULES = (
    ...
    "owner is, what they do, their tastes, favorites, hobbies, travels or daily life (weekends, routines), "
    "or what they can be asked (the about and interests pages answer those).\n"
